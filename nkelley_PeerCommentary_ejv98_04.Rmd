title: "nkelley_PeerCommentary_ejv98_04"
...
#specifies arguments
{
  #ejv98: I believe the Z.prop.test function is missing information. I also had trouble at first with this. You need to state something like if(is.null(p2)==True||is.null(n2)==TRUE){}. In the squiggly brackets, that is where you need to define z, the lower, upper, and ci. Or at least, this is one way to do it. 
...
#ejv98: I think you may need to preceed this chunck with library(curl). That should do the trick!
```
...
#ejv98: This is great start! I apologize for the late commentary. I left a couple of notes where I found issues that were giving me errors! Some of them, I wasn't too sure about myself because we approached the assignment in different ways. Your plots look great! 